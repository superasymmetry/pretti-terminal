import { ConfigError, type PrettiConfig } from './config.js';
...
export function geometry(config: PrettiConfig): { cols: number; rows: number } {
  return {
...
export function requireInteractiveTerminal(): void {
  ...
  throw new ConfigError(
    'pretti records a live terminal session, and its input is not coming from a terminal.\n' +
